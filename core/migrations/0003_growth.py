    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(default='New', max_length=255, db_index=True, choices=[(b'PROCESSING', 'Processing'), (b'PARTIAL', 'Partial'), (b'COMPLETE', 'Complete'), (b'CONTRIBUTE', 'Contribute'), (b'RETRY', 'Retry'), (b'ERROR', 'Error'), (b'NEW', 'New')])),
