    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contribute', models.CharField(max_length=255, choices=[('HttpResourceProcessor.fetch', 'Fetch content from HTTP resource'), ('HttpResourceProcessor.fetch_mass', 'Fetch content from multiple HTTP resources'), ('ExtractProcessor.extract_from_resource', 'Extract content from one or more resources')])),
                ('contribute_type', models.CharField(max_length=255, choices=[('Append', 'Append')])),
