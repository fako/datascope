from legacy.processes.base import Process, Retrieve, GroupProcess
...
class VisualTranslation(Process):
    ...
    # HIF interface
    HIF_translate_model = "WikiTranslate"  # legacy.input.http.wiki
    HIF_image_model = "GoogleImage"  # legacy.input.http.google
    HIF_video_model = "YouTubeSearch"  # legacy.input.http.google
