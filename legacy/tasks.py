...
from legacy.helpers.storage import get_hif_model, copy_hif_model
from legacy.helpers.data import reach
from legacy.helpers.enums import ProcessStatus as statusses


@task(name="legacy.execute_process")
...
@task(name="legacy.extend_process")
...
@task(name="legacy.finish_extend")
