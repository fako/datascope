...
from legacy.models.storage import Storage, TextStorage, ProcessStorage
...
class TestModelIntegrity(TestCase):
    ...
    def test_integrity_model(self):
        ...
        self.assertNotEquals(model, None, "{} can't be retrieved as model by Django. Does it exist, is it placed under models and does it have the legacy app_label?".format(model_name))
