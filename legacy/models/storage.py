...
from legacy.helpers import storage
from legacy.helpers.configuration import Config
from legacy.exceptions import HIFCouldNotLoadFromStorage
from legacy.processes.register import Register
from legacy.processes.extend import Extend
...
class Storage(models.Model):
    ...
    # STORAGE MAIN
    #######################################################
    # These methods are the legacy functionality of this class
